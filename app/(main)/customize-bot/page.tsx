...
import { getChatbotSettingsAction } from "@/actions/chatbot.actions";
...
export default function CustomizeBotPage() {
    ...
    useEffect(() => {
        ...
        const getChatbotSettings = async () => {
            try {
                const response = await getChatbotSettingsAction(storeId);
                if (!response.success) {
                    console.error('Error fetching chatbot settings:', response.message);
                    return;
                }
                setPrimaryColor(response.data.primary_color);
                setHeadingTextColor(response.data.text_colour);
    ...
    return (
        <div className="bg-highlight-background text-highlight-foreground min-h-screen p-6 font-sans card-border-shadow">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-background text-foreground text-card-foreground rounded-2xl p-6 shadow-sm border border-border h-fit">
                        ...
                        <div className="mb-6">
                            <label className="block text-sm font-medium text-muted-foreground mb-2">Color picker {primaryColor}</label>
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-muted-foreground mb-2">Heading Text Color</label>
                        ...
                        <div className="mt-8 pt-6 border-t border-border">
                            ...
                            >
                                ...
                                <span className="text-sm font-medium text-muted-foreground group-hover:text-primary">Upload Avatar</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-background text-foreground rounded-2xl p-2 shadow-sm border border-border flex flex-col items-center justify-center min-h-[600px] p-6">
                        <h3 className="text-xl font-bold text-foreground mb-6 w-full text-left">Chatbot Appearance</h3>
                        ...
                        <div className="w-full max-w-[320px] h-[500px] bg-background rounded-[2rem] shadow-2xl overflow-hidden border border-border relative flex flex-col relative flex flex-col">
                            ...
                            <div
                                ...
                                style={{ backgroundColor: primaryColor, color: headingTextColor, borderColor: headingTextColor }}
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-[10px] opacity-80 !mb-0">Powered By Anticip8</p>
                                    </div>
                                </div>
                                <Button
                                    variant="ghost"
                            ...
                            <div className="flex-1 bg-muted/30 p-4 overflow-y-auto flex flex-col">
                                ...
                                <div className="flex gap-2">
                                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 overflow-hidden shrink-0">
                                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
                                            <path d="M3 5V20.7929C3 21.2383 3.53857 21.4614 3.85355 21.1464L7.70711 17.2929C7.89464 17.1054 8.149 17 8.41421 17H19C20.1046 17 21 16.1046 21 15V5C21 3.89543 20.1046 3 19 3H5C3.89543 3 3 3.89543 3 5Z" stroke={primaryColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            </path> <path d="M15 12C14.2005 12.6224 13.1502 13 12 13C10.8498 13 9.79952 12.6224 9 12" stroke={primaryColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            </path>
                                            <path d="M9 8.01953V8" stroke={primaryColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                            <path d="M15 8.01953V8" stroke={primaryColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                        </g></svg>
                                    </div>
                                    <div className="max-w-[80%]">
                                        <p className="text-sm font-semibold bg-foreground text-background p-2 shadow-sm rounded-2xl rounded-tl-none">How can I help you today?</p>
                                    </div>
                                </div>
                                        ...
                                        {[1, 2].map((i) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center justify-between mt-1">
                                                    ...
                                                    <div
                                                        className="bg-black w-4 h-4 rounded-full flex items-center justify-center text-[8px]"
                                                    >
                        ...
                        <div className="mt-1 flex justify-end w-[320px]">
                            <div className="w-12 h-12 rounded-full shadow-lg flex items-center justify-center text-white" style={{ backgroundColor: primaryColor }}>
                                <svg className="w-7 h-7" fill="none" stroke={headingTextColor} viewBox="0 0 24 24">
